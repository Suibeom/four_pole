...
- r/f: Change particle spawn mode:
    - `uniform` uniformly spawn particles between 1 and 100 mass/charge ratio
    - `sparse` uniformly spawn particles between 10 and 100 mass/charge ratio by tens
    - `1-100`Spawn only particles of a specific mass/charge ratio
